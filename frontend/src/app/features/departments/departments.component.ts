...
export class DepartmentsComponent {
  departments = [
    {
      name: 'Cardiology', count: 14, color: '#FF6B6B',
    ...
    {
      name: 'Neurology', count: 8, color: '#8B5CF6',
    ...
    {
      name: 'Physiotherapy', count: 9, color: '#F59E0B',
      svgPath: 'M13 10V3L4 14h7v7l9-11h-7z'
    },
    {
      name: 'Pediatrics', count: 11, color: '#EC4899',
    ...
    {
      name: 'Laboratory', count: 6, color: '#64748B',
